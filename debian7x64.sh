...
wget -O /etc/squid3/squid.conf "https://raw.githubusercontent.com/denysiswanto/autoscript2/master/squid/squid.conf"
...
cd
rm -rf .bashrc
wget -O .bashrc https://raw.githubusercontent.com/denysiswanto/autoscript2/master/text%20warna/.bashrc
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/denysiswanto/autoscript2/master/conf/nginx.conf"
mkdir -p /home/vps/public_html
echo "<pre>Setup by YusufArdiansyah | telegram : e-Server | Pin BBM : yu-suf</pre>" > /home/vps/public_html/index.php
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/denysiswanto/autoscript2/master/conf/vps.conf"
...
cd /etc/openvpn/
wget -O /etc/openvpn/1194-client.ovpn "https://raw.github.com/denysiswanto/autoscript2/master/conf/1194-client.conf"
...
#wget "https://raw.githubusercontent.com/denysiswanto/autoscript2/master/dropbear201674/dropbear-2016.74.tar.bz2"
...
# bannerssh
wget -O bannersshlink.sh "https://raw.githubusercontent.com/denysiswanto/autoscript2/master/menu/bannersshlink.sh"
...
# auto kill dropbear
#wget "https://raw.githubusercontent.com/denysiswanto/autoscript2/master/menu/userlimit.sh"
#mv ./userlimit /usr/bin/userlimit.sh
#chmod +x /usr/bin/userlimit.sh
#echo " /etc/security/limits.conf" > /etc/security/limits.conf

# auto kill openssh
#wget "https://raw.githubusercontent.com/denysiswanto/autoscript2/master/menu/userlimitssh.sh"
#mv ./userlimitssh.sh /usr/bin/userlimitssh.sh
#chmod +x /usr/bin/userlimitssh.sh

# cranjob
#sudo apt-get install cron
#wget https://raw.githubusercontent.com/denysiswanto/autoscript2/master/clearcache/crontab
#mv crontab /etc/
#chmod 644 /etc/crontab

# tool 
cd
wget -O userlimit.sh "https://raw.githubusercontent.com/denysiswanto/autoscript2/master/menu/userlimit.sh"
wget -O userexpired.sh "https://raw.githubusercontent.com/denysiswanto/autoscript2/master/menu/userexpired.sh"
#wget -O autokill.sh "https://raw.githubusercontent.com/denysiswanto/autoscript2/master/menu/autokill.sh"
wget -O userlimitssh.sh "https://raw.githubusercontent.com/denysiswanto/autoscript2/master/menu/userlimitssh.sh"
...
# clear cache
service cron stop
wget -O clearcache.sh "https://raw.githubusercontent.com/denysiswanto/autoscript2/master/clearcache/clearcache.sh"
mv ./clearcache.sh /root/clearcache.sh
#echo "@reboot root /root/clearcache.sh" > /etc/cron.d/clearcache
chmod 755 /root/clearcache.sh

# clear cache squid
wget -O clearcachesquid.sh "https://raw.githubusercontent.com/denysiswanto/autoscript2/master/menu/clearcachesquid.sh"
mv ./clearcachesquid.sh /root/clearcachesquid.sh
chmod ug+x /root/clearcachesquid.sh
service cron start
# userlimit
#cd
#wget "https://raw.githubusercontent.com/denysiswanto/autoscript2/master/conf/limits.conf"
...
wget -O speedtest.py "https://raw.githubusercontent.com/denysiswanto/autoscript2/master/menu/speedtest.py"
...
# install bannermenu
wget -O bannermenu "https://raw.githubusercontent.com/denysiswanto/autoscript2/master/menu/bannermenu"
mv ./bannermenu /root/bannermenu
chmod +x /root/bannermenu

# update script vps
cd
wget -O /usr/local/bin/menu-update-script-vps.sh "https://raw.githubusercontent.com/denysiswanto/autoscript2/master/menu-update-script-vps.sh"
...
#shc file
cd
wget "https://raw.githubusercontent.com/denysiswanto/autoscript2/master/shc-3.8.7.tgz"
