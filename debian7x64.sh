...
wget -O /etc/squid3/squid.conf "https://raw.githubusercontent.com/danangtrihermansyah/premium/master/squid/squid.conf"
...
cd
rm -rf .bashrc
wget -O .bashrc https://raw.githubusercontent.com/danangtrihermansyah/premium/master/text%20warna/.bashrc
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/danangtrihermansyah/premium/master/conf/nginx.conf"
mkdir -p /home/vps/public_html
echo "<pre>Setup by YusufArdiansyah | telegram : e-Server | Pin BBM : yu-suf</pre>" > /home/vps/public_html/index.php
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/danangtrihermansyah/premium/master/conf/vps.conf"
...
# auto kill dropbear
#wget "https://raw.githubusercontent.com/danangtrihermansyah/premium/master/menu/userlimit.sh"
#mv ./userlimit /usr/bin/userlimit.sh
#chmod +x /usr/bin/userlimit.sh
#echo " /etc/security/limits.conf" > /etc/security/limits.conf

# auto kill openssh
#wget "https://raw.githubusercontent.com/danangtrihermansyah/premium/master/menu/userlimitssh.sh"
#mv ./userlimitssh.sh /usr/bin/userlimitssh.sh
#chmod +x /usr/bin/userlimitssh.sh

# cranjob
#sudo apt-get install cron
#wget https://raw.githubusercontent.com/danangtrihermansyah/premium/master/clearcache/crontab
#mv crontab /etc/
#chmod 644 /etc/crontab

# tool 
cd
wget -O userlimit.sh "https://raw.githubusercontent.com/danangtrihermansyah/premium/master/menu/userlimit.sh"
wget -O userexpired.sh "https://raw.githubusercontent.com/danangtrihermansyah/premium/master/menu/userexpired.sh"
#wget -O autokill.sh "https://raw.githubusercontent.com/danangtrihermansyah/premium/master/menu/autokill.sh"
wget -O userlimitssh.sh "https://raw.githubusercontent.com/danangtrihermansyah/premium/master/menu/userlimitssh.sh"
...
# clear cache
service cron stop
wget -O clearcache.sh "https://raw.githubusercontent.com/danangtrihermansyah/premium/master/clearcache/clearcache.sh"
mv ./clearcache.sh /root/clearcache.sh
#echo "@reboot root /root/clearcache.sh" > /etc/cron.d/clearcache
chmod 755 /root/clearcache.sh

# clear cache squid
wget -O clearcachesquid.sh "https://raw.githubusercontent.com/danangtrihermansyah/premium/master/menu/clearcachesquid.sh"
mv ./clearcachesquid.sh /root/clearcachesquid.sh
chmod ug+x /root/clearcachesquid.sh
service cron start
# userlimit
#cd
#wget "https://raw.githubusercontent.com/danangtrihermansyah/premium/master/conf/limits.conf"
...
wget -O speedtest.py "https://raw.githubusercontent.com/danangtrihermansyah/premium/master/menu/speedtest.py"
...
# install bannermenu
wget -O bannermenu "https://raw.githubusercontent.com/danangtrihermansyah/premium/master/menu/bannermenu"
mv ./bannermenu /root/bannermenu
chmod +x /root/bannermenu

# update script vps
cd
wget -O /usr/local/bin/menu-update-script-vps.sh "https://raw.githubusercontent.com/danangtrihermansyah/premium/master/menu-update-script-vps.sh"
...
wget https://raw.githubusercontent.com/danangtrihermansyah/premium/master/ram/fstab
mv ./fstab /etc/fstab
chmod 644 /etc/fstab
